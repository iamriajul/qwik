...
export interface LinkProps extends AnchorAttributes {
  /**
   * Whether Link should prefetch and cache the data (routeLoader$, onGet, etc.) for this page. This
   * occurs when the Link receives a mouseover or focus event on desktop, or when visible on mobile.
   * (defaults to false)
   */
  prefetch?: boolean;

  /**
   * Whether Link should prefetch the javascript bundles required to render this page. This occurs
   * when the Link becomes visible on the page. Symbols are not prefetched in dev mode. (defaults to
   * true)
   */
